    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto space-y-3 sm:space-y-4 pr-2 scrollbar-thin scrollbar-thumb-cyan-500 scrollbar-track-gray-100 hover:scrollbar-thumb-cyan-600">
          ...
          {/* Phụ cấp + Bảo hiểm — chỉ nhân sự */}
          {!isSupplier && (
            <Row gutter={[16, 16]}>
              <Col xs={24} sm={8} lg={8}>
                <Form.Item
                  name="allowance"
                  label={<span className="text-sm sm:text-base font-semibold text-gray-700">Phụ cấp:</span>}
                  className="!mb-0"
                >
                  <InputNumber
                    style={{ width: "100%" }}
                    ...
                    min={0}
                    formatter={(v) => v !== undefined ? String(v).replace(/\B(?=(\d{3})+(?!\d))/g, ".") : ""}
              ...
              <Col xs={24} sm={8} lg={8}>
                <Form.Item
                  name="bhyt"
                  label={<span className="text-sm sm:text-base font-semibold text-emerald-700">BHYT (trừ):</span>}
                  className="!mb-0"
                >
                  <InputNumber
                    style={{ width: "100%" }}
              ...
              <Col xs={24} sm={8} lg={8}>
                <Form.Item
                  name="bhxh"
                  label={<span className="text-sm sm:text-base font-semibold text-rose-700">BHXH (trừ):</span>}
                  className="!mb-0"
                >
                  <InputNumber
                    style={{ width: "100%" }}
